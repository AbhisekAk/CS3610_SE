...
from FoodAbstractFactory.VegfoodFactory import VegFoodFactory
from FoodAbstractFactory.NonVegFoodFactory import NonVegFoodFactory
...
class FoodApp:
    ...
    def getOrderDescription(self, products: List[IFood]):
        lines = []
        total = 0
        cals=0
